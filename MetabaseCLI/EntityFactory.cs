...
namespace MetabaseCLI
{
    public class EntityFactory
    {
        ...
        public string ArchivedItems { get; set; }
        ...
        private IObservable<IDictionary<string, dynamic>> ParseGet(
        ...
        )
        {
            return source
                ...
                kv => kv.Key,
                kv => (internalFields.ContainsKey(kv.Key) 
        ...
        public IObservable<IDictionary<string, dynamic>> Update(
            ...
            updated => AfterUpdateCallback?.Invoke(session, entity, updated)??
        ...
        public IObservable<IDictionary<string, dynamic>> Delete(
            Session session,
            int id
        ) => session.Delete<IDictionary<string, dynamic>>($"{Name}/{id}");
    }
}
